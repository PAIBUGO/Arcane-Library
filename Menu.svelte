...
<div class="relative px-8">
	<Navbar class="fixed start-0 top-0 z-20 w-full bg-gray-800 px-2 py-2.5 sm:px-4">
		...
		<NavUl>
			<NavLi
				href="/"
				class="text-lg font-bold px-4 py-2 text-primary-500 dark:text-primary-400 hover:text-yellow-300 hover:bg-gray-700 focus:text-yellow-400 focus:bg-gray-700 transition-colors ro[...]"
			>
				Home
			</NavLi>
			<NavLi
				href="/about"
				class="text-lg font-bold px-4 py-2 text-primary-500 dark:text-primary-400 hover:text-yellow-300 hover:bg-gray-700 focus:text-yellow-400 focus:bg-gray-700 transition-colo[...]"
			>
				Sobre
			</NavLi>
			...
			{#if hasToken}
				{#if user}
					...
					{#if user.role === 'admin'}
						...
						<NavLi
							href="/users"
							class="text-lg font-bold px-4 py-2 text-primary-500 dark:text-primary-400 hover:text-yellow-300 hover:bg-gray-700 focus:text-yellow-400 focus:bg-gray-700 transitio[...]"
						>
							Usuários
						</NavLi>
					{/if}
				...
				{:else}
					<NavLi
						href="/login"
						class="text-lg font-bold px-4 py-2 text-primary-500 dark:text-primary-400 hover:text-yellow-300 hover:bg-gray-700 focus:text-yellow-400 focus:bg-gray-700 transition[...]"
					>
						Login
					</NavLi>
				{/if}
			{:else}
				...
				<NavLi
					href="/login"
					class="text-lg font-bold px-4 py-2 text-primary-500 dark:text-primary-400 hover:text-yellow-300 hover:bg-gray-700 focus:text-yellow-400 focus:bg-gray-700 transition-c[...]"
				>
					Login
				</NavLi>
			{/if}
